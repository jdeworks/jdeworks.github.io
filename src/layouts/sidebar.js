...
export function render(d, cs, ts, hs) {
  ...
  <div style="display:flex;min-height:100vh;flex-direction:row;" class="layout-sidebar">
    <style>.layout-sidebar { flex-direction: row; } @media(max-width:768px){ .layout-sidebar { flex-direction: column !important; } .layout-sidebar > aside { width: 100% !important; position: relative !important; min-height: auto !important; padding: 2rem !important; } .layout-sidebar > main { padding: 2rem !important; } }</style>
    <aside style="width:320px;min-height:100vh;background:var(--bg2);padding:3rem 2rem;display:flex;flex-direction:column;position:sticky;top:0;align-self:flex-start;border-right:1px solid var(--border);">
